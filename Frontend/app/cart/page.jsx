                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div className="lg:col-span-2 space-y-4">
                            {cartItems.map((item) => (
                                <div key={item.id} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-5 flex items-center gap-6 group transition-all hover:bg-white/10 hover:border-green-500/20">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="mt-3 flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-white font-bold bg-white/10 px-3 py-1 rounded-lg border border-white/5">{item.quantity}</span>
                                            </div>
