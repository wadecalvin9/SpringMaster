                ...
                <div className="w-full max-w-md">
                    <div className="text-center mb-10">
                        ...
                        <p className="mt-3 text-slate-400 font-medium">
                            Join the GreenHouse community today
                        </p>
                    </div>
                    ...
                    <p className="mt-8 text-center text-sm text-slate-400 font-medium">
                        ...
                        <Link href="/login" className="text-green-500 hover:text-green-400 font-bold transition-all underline decoration-green-500/30 underline-offset-4 hover:decoration-green-500">
                            Sign in here
                        </Link>
                    </p>
                </div>
